package com.wangwb.web.items.geetest.demo;
...
import com.wangwb.web.items.geetest.sdk.GeetestLib;
import com.wangwb.web.items.geetest.sdk.GeetestLibResult;
 ...
 * 二次验证接口，POST请求
 */
@WebServlet(name = "secondValidateServlet", urlPatterns = "/secondValidateServlet")
